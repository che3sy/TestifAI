...
function displayQuestion(data) {
  ...
  questionTitle.innerHTML = data.question; // Use innerHTML to allow LaTeX notation
  ...
  gradeButton.addEventListener("click", () =>
    gradeAnswer(answerArea.value, answerArea, gradeButton),
  );
  ...
  rubricText.innerHTML = data.rubric;
...
async function gradeAnswer(userAnswer, answerArea, gradeButton) {
  ...
  try {
    const response = await fetch(
      `https://x4f6ezfwiloumemi2tkgozxltu0ufwjn.lambda-url.us-west-2.on.aws/grade?id=${id}`,
    );
...
const _supabase = createClient(
  "https://llhpftmlgrgmosegssmr.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxsaHBmdG1sZ3JnbW9zZWdzc21yIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjMwMTU1NDksImV4cCI6MjAzODU5MTU0OX0.Xmdjm4t5w9CBr0yKHjx_yP1nhGyoeqPZVKJXzfvfF4g",
);
